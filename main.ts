...
game.showLongText("It is july 2019", DialogLayout.Bottom)
game.showLongText("and a huge forest fire has occurred in australia", DialogLayout.Bottom)
game.showLongText("you are on the front line", DialogLayout.Bottom)
game.showLongText("and have to defend the forest from being burnt down to ASH!", DialogLayout.Bottom)
game.showLongText("Use the joystick to move and hold the A button to spray water", DialogLayout.Bottom)
